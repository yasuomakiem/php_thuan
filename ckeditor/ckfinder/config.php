...
//link lay license keygen free chuẩn Bùi Văn mạnh

$config['licenseName'] = 'duonggiaadi.com';
$config['licenseKey']  = 'GYPYCSJEGHFT9H9WWXHME6T61G3P8';
...
$config['backends'][] = array(
    'name'         => 'default',
    'adapter'      => 'local',
    'baseUrl'      => '/upload/ck/', //Thư mục chứa file upload
