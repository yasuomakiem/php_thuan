<?
            echo '<div class="tit">Cài đặt Tab trắng</div>';
            if(isset($_POST['tabtrang'])){
            ...
            $t1=addslashes($_POST['t1']);
                ...
                $in="update set_home set ten=N'$ten',t1=N'$t1',bg='$tenanhbg',color='$color' where id=$re[id]";
        ...
        <form id="form" action="" method="post"  enctype="multipart/form-data">
            ...
            <?php echo $thongbao; ?>
                ...
                <tr>
                    <th>Nội dung:</th><td><textarea id="thongtin" name="t1"><?=$re['t1']?> </textarea></td>
                </tr>
                ...
                <tr>
                    <th></th><td><input type="submit" name="tabtrang" value="CẬP NHẬT" /></td>
                </tr>
            </table>
        </form>
