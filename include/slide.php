...
<section class="home-banner">
    <ul id="home-banner">
    <?$bn=@mysql_query("select * from dh_banner where vitri=2 order by time desc");while($rb=@mysql_fetch_assoc($bn)){?>
    <li>
                ...
                <div class = "container-slider" style = 'display: none'>
                    <div class="container">
                        <div class="box right">
                            ...
                            <!--<a href="<?=$rb['a']?>" class="btn viewmore" style="background-color: ">Xem chi tiết</a>-->
                            </div>
                    </div>
                </div>                    
    </li>
