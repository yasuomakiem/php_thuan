...
$tin=@mysql_fetch_assoc(@mysql_query("select * from tin where id=$idtin"));
$khach=@mysql_fetch_assoc(@mysql_query("select * from user where id=$tin[idu]"));
?>
    ...
    <div class="boxnaptien">
        ...
        return false;
          ...
          <div class="form-group">
            <label>Tiêu đề <sup style="color: red;">(*)</sup></label>
            <input type="text" required="" name="tieude" class="form-control" value="<?=$khach['tieude']?>" placeholder="Tiêu đề tin"/>
          </div>
          <div class="form-group">
