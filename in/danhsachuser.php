        ...
        return false;
            ...
            <?}else{?>
                ...
                <?
                    ...
                    $khtn=@mysql_query("select * from user where $themlist order by id asc");
                    $solg=@mysql_num_rows($khtn);
                    $them='?page=';
                ?>
            
            <p><a style="float: right;padding-top: 7px;" href="/m/danhsachuser/?list=<?=$_GET['list']?>&add=1"><i class="fas fa-plus-circle"></i> Thêm tài khoản</a>
            <br />
            </p>
            <div class="clearfix"></div>
            <?
