<p><a href="m/nguon/"><i class="fas fa-chevron-left"></i> Trở lại</a> / Thêm nguồn bán</p>
    <div class="boxme">
        <form role="form">
          <div class="form-group">
            <label>Tiêu đề gợi nhớ</label>
            <input type="text" class="form-control" id="ten" placeholder="VD: Nhà 304 Nguyễn Trãi, anh Thành"/>
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="diadiem" placeholder=""/>
             <script language="javascript">
          ...
          <div class="form-group">
            ...
            <input type="number" class="form-control" value="0" id="giagoc" placeholder=""/>
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="giaban" placeholder="500tr, 2tỷ5xx....Giá hiển thị cho sale khác"/>
            
          </div>
          
          <div class="form-group">
            <label>Phí Sale</label><b style="float: right;color: darkorange;font-weight: normal;" id="showsale"></b>
            <input type="number" class="form-control" id="phisale" value="0" placeholder=""/>
          ...
          <script language="javascript">
            ...
            <div id="showthu5" class="chonanh" <?=$e_anhthem[1]?> onclick="document.getElementById('main_picture5').click();"></div>
            <input type="file" id="main_picture5" name="image5" style="display: none;" accept="image/*"/> 
            <input type="hidden" id="data_picture5" />
            <div id="showthu6" class="chonanh" <?=$e_anhthem[2]?> onclick="document.getElementById('main_picture6').click();"></div>
            <input type="file" id="main_picture6" name="image6"  style="display: none;" accept="image/*"/> 
            <input type="hidden" id="data_picture6" />
            <div id="showthu7" class="chonanh" <?=$e_anhthem[3]?> onclick="document.getElementById('main_picture7').click();"></div>
            <input type="file" id="main_picture7" name="image7"  style="display: none;" accept="image/*"/> 
            <input type="hidden" id="data_picture7" />
            <div id="showthu8" style="margin-right: 0;" class="chonanh" <?=$e_anhthem[4]?> onclick="document.getElementById('main_picture8').click();"></div>
            <input type="file" id="main_picture8" name="image8"  style="display: none;" accept="image/*"/>
            <input type="hidden" id="data_picture8" />
  ...
  <div class="checkbox">
    ...
    <label>
      ...
      <input type="checkbox" checked="" value="1" name="guinguon"/> Đẩy nguồn lên chợ "Mua bán" để Sale khác liên hệ

    </label>
  </div>

  <button type="button" class="btn btn-primary" id="dangtin"><i class="fas fa-paper-plane"></i> Đăng nguồn</button>
<p id="dk"></p>
</form>
<script language="javascript">
$('#dangtin').click(function(){
    ...
    var anh1 = $("#data_picture1").val(); anh1=anh1.replace('data:image/jpeg;base64,','');
    var anh2 = $("#data_picture2").val(); anh2=anh2.replace('data:image/jpeg;base64,','');
    var anh3 = $("#data_picture3").val(); anh3=anh3.replace('data:image/jpeg;base64,','');
    var anh4 = $("#data_picture4").val(); anh4=anh4.replace('data:image/jpeg;base64,','');
    var anh5 = $("#data_picture5").val(); anh5=anh5.replace('data:image/jpeg;base64,','');
    var anh6 = $("#data_picture6").val(); anh6=anh6.replace('data:image/jpeg;base64,','');
    var anh7 = $("#data_picture7").val(); anh7=anh7.replace('data:image/jpeg;base64,','');
    var anh8 = $("#data_picture8").val(); anh8=anh8.replace('data:image/jpeg;base64,','');
