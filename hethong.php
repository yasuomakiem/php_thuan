...
<div class="bigmem cpanel">
        <h3 style="color: white; padding-left: 30px; margin-top: 0; font-size: 18px; margin-bottom: 25px;"><a href="/m/cpanel/" style="color: white;"><i class="fas fa-globe"></i> Bảng điều khiển</a> <a style="float: right;font-size: 14px;padding-right: 20px;color: yellow;" href="logout.php">Thoát <i class="fas fa-sign-out-alt"></i></a></h3>
            <div class="contag dr">
                <img src="i/treemap.png" />
                <div class="dealright">
                <p><b>Sơ đồ cây hệ thống</b></p>
                <?
                $sll=@mysqli_num_rows(@mysqli_query($con,"select * from dh_user where hethong like '%$u[id]%'"));
                ?>
    ...
    <li>
        <span class="male" id="iduser_1"><a style="text-decoration: none; color: #004040; font-weight: bold;" href="">Một</a></span>
        <ul>
            <li class="closed">
                <span class="female" id="3"> <a href="">Hai</a></span>
                <ul>
                    <li><span class="female" id="3"> <a href="">Hai Một</a></span></li>
                    <li class="closed"><span class="female" id="3"> <a href="">Hai Hai</a></span>
                        <ul>
                            <li><span class="male" id="3"> <a href="">Hai Hai Một</a></span></li>
                            <li><span class="female" id="3"> <a href="">Hai Hai Hai</a></span></li>
                            <li><span class="male" id="3"> <a href="">Hai Hai Ba</a></span></li>
                            <li class="closed"><span class="female" id="3"> <a href="">Hai Hai Bốn</a></span>
                                <ul>
                                    <li><span class="male" id="3"> <a href="">224 Một</a></span></li>
                                    <li><span class="female" id="3"> <a href="">224 Hai</a></span></li>
                                    <li><span class="female" id="3"> <a href="">224 Ba</a></span></li>
                                    <li><span class="female" id="3"> <a href="">224 Bốn</a></span></li>
                                </ul>
                            </li>
                        </ul>
                    </li>
                    <li><span class="female" id="3"> <a href="">Hai Ba</a></span></li>
                    <li><span class="female" id="3"> <a href="">Hai Bốn</a></span></li>
                </ul>
            </li>
            <li class="closed">
                <span class="male" id="3"> <a href="">Ba</a></span>
                <ul>
                    <li><span class="female" id="3"> <a href="">Ba Một</a></span></li>
                    <li class="closed"><span class="female" id="3"> <a href="">Ba Hai</a></span>
                        <ul>
                            <li class="closed"><span class="female" id="3"> <a href="">Ba Hai một</a></span>
                                <ul><li><span class="female" id="3"> <a href="">321 một</a></span></li></ul>
                            </li>
                        </ul>
                    </li>
                    <li><span class="female" id="3"> <a href="">Ba Ba</a></span></li>
                    <li><span class="female" id="3"> <a href="">Ba Bốn</a></span></li>
                </ul>
            </li>
        </ul>
    </li>
            ...
            if($i<7){
            $list_page.="<li><a href=\"/m/danhsachuser/".$them.$i."\">".$i."</a></li>";
            }
            ...
            if($number_of_page>8 and $page<=4){$list_page=$list_page."<li>...</li><li><a href=\"/m/danhsachuser/".$them.=$number_of_page."\">".$number_of_page."</a></li>";}
            ...
            if($chamdauduoi==1){$list_page="<li><a href=\"/m/danhsachuser/".$them."1\">1</a></li><li>...</li>".$list_page."<li>...</li>
            <li><a href=\"/m/danhsachuser/".$them.$number_of_page."\">".$number_of_page."</a></li>";}
            //trường hợp trang hiện tại không phải là trang cuối thì hiện thị chữ >
            if($number_of_page!=$page){ $pcong=$page+1;
            $list_page=$list_page."
            <li>
        		<a class=\"last \" aria-label=\"Next\" href=\"/m/danhsachuser/".$them.$pcong."\">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12 kh" id="khung<?=$rkh['id']?>">
                <p><b><?=$i?>. <?=$rkh['fullname']?></b> <i style="float: right;">Hạn dùng: <b><?if($rkh['timedichvu']==0){echo 'N/a';}else{echo retime_ngay($rkh['timedichvu']);}?></b></i></p>
                <p class="nut"> 
                <?if($rkh['uid']!=''){?>
